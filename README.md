...
* In order to have pre-set images, you can put some images you would like 
  to use in this project into `storage/app/public/images` and then run `php artisan db:seed`
